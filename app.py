...
if "Centrifugal Pumps" in module or "مضخات الطرد المركزي والمعايير الأولية" in module:
    ...
    st.write("قم برفع الصور أو الفيديوهات مع كتابة وصف أو شرح بصوتك أو نصك **بأي لغة أو لهجة (اللهجة العراقية، الفصحى، الإنجليزية، اليابانية، الهندية، الكورية، أو الصينية)**.")
    ...
    if stored_media_files:
        ...
        with col_m2:
            ...
            user_explanation_input = st.text_area(
                "أدخل الشرح أو الملاحظات حول الصورة/الفيديو (يدعم اللهجة العراقية، الفصحى، الإنجليزية، إلخ):",
